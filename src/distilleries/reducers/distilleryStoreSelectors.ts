...
import { denormalizeContainers } from '../../containers/services/containerNormalizr';
import { denormalizeDistilleries } from '../services/distilleryNormalizr';
import { DistilleryStoreState } from './distilleryStoreReducer';
...
export const getNestedDistilleries = createSelector(
  ...
  (entities: any, result: any) => denormalizeDistilleries(result, entities),
);
