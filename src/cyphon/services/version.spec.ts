...
describe('version', () => {
  describe('parseVersion()', () => {
    it(
      'should correctly parse a semantic version object from a string that contains major, ' +
      'minor, and patch info',
      () => {
  ...
  describe('getCyphonVersionRange()', () => {
    it('should return the range that matches a specified start and end point', () => {
    ...
    it('should return the range that matches a specified start and infinite end point', () => {
  ...
  describe('cyclopsVersionMatchesCyphonVersion()', () => {
    ...
    it('should throw a TypeError if the matching Cyphon version isnt present', () => {
  ...
  describe('versionToString()', () => {
    it('should return a wildcard for a major version that equals Infinity', () => {
      const versionNumber = version.versionToString([Infinity, Infinity, Infinity]);

      expect(versionNumber).toEqual('*');
    });

    it('should return a wildcard for the minor version if it equals infinity', () => {
      const versionNumber = version.versionToString([2, Infinity, Infinity]);

      expect(versionNumber).toEqual('2.*');
    });

    it('should return a wildcard for the patch version if it equals infinity', () => {
      const versionNumber = version.versionToString([2, 5, Infinity]);

      expect(versionNumber).toEqual('2.5.*');
    });

    it('should return the full version number', () => {
      const versionNumber = version.versionToString([2, 5, 12]);
