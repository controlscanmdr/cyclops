...
import {
  ...
  versionToString,
} from '../../cyphon/services/version';
import { getConfig, getVersion } from '../../app/services/config';
...
export class VersionMatchError extends React.Component<Props, {}> {
  ...
  cyphonVersionRange?: SemanticVersionRange;
  cyclopsVersion?: string;
  cyphonVersion?: string;
