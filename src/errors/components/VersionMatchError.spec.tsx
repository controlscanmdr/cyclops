...
describe('<VersionMatchError />', () => {
  ...
  it('should display an error message if the Cyclops version is not found', () => {
    const element = component().find('div').first();

    expect(element.text()).toEqual('Could not find Cyclops version number.');
  });

  it('should display an error message if the Cyphon version is not found', () => {
  ...
  it('should display an error message if the Cyphon version range is not found', () => {
  ...
  it('should display an error message explaining that the versions are not compatible', () => {
