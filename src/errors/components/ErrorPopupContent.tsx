...
import { getErrorType } from '../services/getErrorType';
import {
  RUNTIME_ERROR,
  API_ERROR,
  NETWORK_ERROR,
  UNKNOWN_ERROR,
} from '../services/errorTypes';
...
export class ErrorPopupContent extends React.Component<Props, {}>  {
   ...
   */
  static ERROR_DISPLAYS: Dictionary<ErrorDisplay> = {
    ...
    // If the error returned does not fall under any of the previous categories.
    [UNKNOWN_ERROR]: error => (
      <div>
