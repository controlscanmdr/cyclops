...
import { CLUSTER_LAYERS } from './mapOptions';

describe('createClusterLayers', () => {
  it(
    'should create the same number of layers outlined in CLUSTER_LAYERS ' +
  ...
  it('should name each layer id by it\'s index and the last one should be called count', () => {
    const sourceId = 'test';
