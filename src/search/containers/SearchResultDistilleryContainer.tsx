...
// Local
import { DispatchToProps, StateToProps } from '../../common/types/Redux';
import { SearchResultDistillery } from '../components/SearchResultDistillery';
import { Dictionary } from '../../common/types/object';
import { DistillerySearchResults } from '../types/Search';
import { selectDistillery } from '../actions/searchResultsActions';
