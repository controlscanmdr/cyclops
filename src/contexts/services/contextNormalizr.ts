...
// Local
import { ContextNested, NormalizedContextList } from '../types/Context';
import { CONTEXT_LIST_SCHEMA, CONTEXT_SCHEMA } from './contextSchema';
 ...
 */
export function normalizeContexts(contexts: ContextNested[]): NormalizedContextList {
 ...
 */
export function denormalizeContexts(contexts: NormalizedContextList): ContextNested[] {
  return denormalize(
    contexts.result,
    CONTEXT_LIST_SCHEMA,
    contexts.entities,
