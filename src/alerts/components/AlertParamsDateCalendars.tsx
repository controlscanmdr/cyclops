...
export class AlertParamsDateCalendars extends React.Component<Props, State> {
   ...
   */
  static createDate(date?: string): Date | undefined {
   ...
   */
  updateDate = (property: DateProperties, date?: Date): void => {
   ...
   */
  handleAfterChange = (value: moment.Moment | string): void => {
   ...
   * @param value New date to set to.
   */
  handleBeforeChange = (value: moment.Moment | string): void => {
    if (_.isString(value)) { return; }
