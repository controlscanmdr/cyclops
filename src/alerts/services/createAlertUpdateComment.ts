...
import { getOutcomeDisplayName } from './getOutcomeDisplayName';
import { getUserFullName } from '../../users/services/getUserFullName';
import { isCurrentUser } from '../../users/services/isCurrentUser';

// Function that creates a comment describing an alert update.
type CommentCreator = (alert: AlertDetail, update: AlertUpdateRequest) => string;
