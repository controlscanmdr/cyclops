...
// Local
import { Alert, AlertUpdateRequest } from '../types/Alert';

// Information about the validity of an alert update.
 ...
 */
export function checkAlertUpdate(alert: Alert, update: AlertUpdateRequest): AlertUpdateCheck {
