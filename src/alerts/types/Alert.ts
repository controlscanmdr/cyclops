...
import {
  ...
  Distillery,
  DistilleryMinimal,
} from '../../distilleries/types/Distillery';
import { CommentNested, Comment } from '../../common/types/comments';
import { DispatchNested, Dispatch } from '../../common/types/dispatches';
import { NormalizedList, NormalizedEntity } from '../../common/types/normalizr';
import { TagDetail } from '../../tags/types/Tag';
...
export type AlertOutcomeChoices = 'completed' | 'duplicate' | 'false positive' | 'N/A' | null;
