...
import { CLOSE_DATA_MODAL } from '../actions/alertDetailActions';
import * as requests from '../../cyphon/services/requests';
 ...
 */
export const alertDataContextSearch = handleActions<AlertDataContextSearchState, any>(
  reducers,
  INITIAL_STATE,
);
