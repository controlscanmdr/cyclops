...
import * as api from '../../alerts/services/alertsAPI';
import * as errorActions from '../../errors/actions/errorModalActions';
...
describe('categoryActions', () => {
  ...
  describe('fetchCategoriesSuccess()', () => {
    it(
      'should make a FETCH_CATEGORIES_SUCCESS action with a normalized ' +
